<div class="product-card position-relative">
    <div class="product-card__top">
        <a href=<?php echo PUBLIC_URL . "productdetail/" . $product['id_product'] . urlencode($product['product_name'])?>>
            <img src=<?php echo IMG_PATH . $imageFileName ?> class="product-card__top--img" alt="">
        </a>
    </div>

    <div class="product-card__label position-absolute top-0 d-flex flex-column-reverse">
        <a href="<?php echo PUBLIC_URL . "productdetail/" . urlencode($product['product_name'])?>"><i class="icon-eye"></i></a>
        <i class="icon-heart"></i>
    </div>

    <div class="product-card__body">
        <p class="product-card__body--name"><?php echo $product['product_name']?></p>

        <div class="product-card__body--content justify-content-between align-items-center">
            <p class="product-card__body--price"><?php echo number_format($product['price'], 0, ',', '.') . "đ" ?><span class="ms-1"></span></p>
